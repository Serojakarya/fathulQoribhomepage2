...
$(function () {
    var e = audiojs.createAll({
        trackEnded: function () {
            var e = $("ul li.playing").next();
            if (!e.length) e = $("ul li").first();
    ...
    $(document).keydown(function (e) {
        ...
        if (n == 39) {
            ...
            if (!r.length) r = $("ul li").first();
            r.click()
        } else if (n == 37) {
            var i = $("li.playing").prev();
            if (!i.length) i = $("ul li").last();
            i.click()
        } else if (n == 32) {
            t.playPause()
        }
